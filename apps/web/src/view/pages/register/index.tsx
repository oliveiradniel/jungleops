import { AuthPageTemplate } from '@/view/components/auth-page-template';
...
export function Register() {
  ...
  return (
    <AuthPageTemplate
      ...
      calloutText="Gerencie suas tarefas, acompanhe prazos, envolva sua equipe e mantenha o fluxo de trabalho sob controle com o JungleOps."
